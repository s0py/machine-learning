...
ggplot(conf_matrix_df, aes(x = prediction, y = default)) +
  ...
  theme_minimal()
ggsave(filename="plots/10b - confusion matrix - random forest categorical - some use of revolving credit.png")
...
ggplot(conf_matrix_df, aes(x = prediction, y = default)) +
  ...
  labs(title = "Confusion Matrix", x = "Prediction", y = "Actual") +
  theme_minimal()
ggsave(filename="plots/10d - confusion matrix - random forest categorical - never used revolving credit.png")
# this test, even with low accuracy, is actually good.
...
ggplot(conf_matrix_df, aes(x = prediction, y = default)) +
  ...
  labs(title = "Confusion Matrix", x = "Prediction", y = "Actual") +
  theme_minimal()
ggsave(filename="plots/10f - confusion matrix - random forest categorical - only used revolving credit.png")
