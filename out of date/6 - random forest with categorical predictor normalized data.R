...
ntree = 100
random_forest_model <- randomForest(as.factor(Defaulted) ~ ., data = training_df, ntree = ntree)
...
filename = paste("plots/6b - plot random forest categorical - normalized data -", ntree, "trees.png")
